...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        System.out.println("inum1과 1num2가 같은지 비교 " + (inum1 == inum2 ));
        System.out.println("inum1과 1num2가 다른지 비교 " + (inum1 != inum2 ));
        System.out.println("inum1이 1num2보다 큰지 비교 " + (inum1 > inum2 ));
        System.out.println("inum1이 1num2보다 크거나 같은지 비교 " + (inum1 >= inum2 ));
        System.out.println("inum1이 1num2보다 작은지 비교 " + (inum1 < inum2 ));
        System.out.println("inum1이 1num2보다 작거나 같은지 비교 " + (inum1 <= inum2 ));
