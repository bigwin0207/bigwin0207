...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        /* 1-2 실수와 실수의 연산 */
        /* 실수끼리 의 연산도 수학에서 사용하는 사칙연산에 나머지를 구하는 연산을 사용할 수 있다. */
        ...
        * */
        ...
        /* 문자열과 연산은 '+' 연산만 가능하다. */
        /* 연산 결과는 다른형태의 값들도 문자열로 취급하여 문자열 이어 붙이기(문자열 합치기) 결과가 나오게 된다*/
        System.out.println("=======문자열와 다른 형태의 값 연산=======");
        /* 3-2-1 문자열과 정수의 연산*/
        System.out.println("helloworld" + 123);
        /* 3-2-2 문자열과 실수의 연산*/
        System.out.println("helloworld" + 1.4823);
        /* 3-2-3 문자열과 문자의 연산*/
        ...
        */       //에러발생
        ...
        /* 4-3 논리값과 실수의 연산*/
        /* 논리값과 실수의 연산은 모든 연산자의 사용이 불가능하다. */
        /*
        System.out.println(true + 0.1);
        System.out.println(true - 0.11);
        System.out.println(true * 0.21);
        System.out.println(true / 0.23);
        System.out.println(true % 0.24);
        */      //에러발생

        /* 4-4 논리값과 문자의 연산*/
        /* 논리값과 문자의 연산은 모든 연산자의 사용이 불가능하다. */
        /* 이유: 문자는 내부적으로 숫자취급을 하기 때문이다. */
        /*
        ...
        */      //에러발생
        ...
        /* 이유는 위에서 테스트 해본 문자열 합치가 되는 원리와 동일하다. */
        System.out.println("=======논리와 문자열의 연산=======");
        System.out.println(true + "a"); //문자열 합치기가 된다.
        /*System.out.println(true - "a");
        System.out.println(true * "a");
        System.out.println(true / "a");
