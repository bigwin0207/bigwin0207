...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        *  다른 메소드간 서로 공유해야하는 값이 존재하는경우 메소드를 호출 시 괄호 이용해서
        *  값을 전달할 수 있다.
        ...
        * */
        ...
        /*1. 전달인자로 값 전달 테스트*/
        app3.testMethod(40);
        //app3.testMethod("40");    //매개변수는 int 형이지만 전달인자가 String 이기 때문에 호출할 수 없다.
        //app3.testMethod(20,30,40);    //매개변수는 int 이지만 인자는 3개이기 때문에 호출할 수 없다.
