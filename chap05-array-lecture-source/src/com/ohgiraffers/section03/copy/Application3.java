...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        * 서로 같은 값을 가지고 있지마, 두 배열은 서로 다른 배열이기 때문에
        * 하나의 배열을 변경 하더라도 다른 배열에는 영향을 주지 않는다.
        * */

        /* 깊은 복사를 하는 방법은 4가지가 있습니다.
        *  1. for문을 이용한 동일한 인덱스 값 복사
        *  2. 0bject의 clone()을 이용한 복사
        *  3. System의 arraycopy()를 이용한 복사
        *  4. Array의 copy0f()를 이용한 복사
        *   이 중에 가장 높은 성능을 보이는 것은 숫수 배열의 복사를 위해 만들어진 arrycopy()메소드이며,
        *   가장 많이 사용되는 방식은 좀 더 유연한 방식인 copy0f() 메소드이다.
