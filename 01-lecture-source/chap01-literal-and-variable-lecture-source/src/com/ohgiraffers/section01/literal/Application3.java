...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(9 + "9" + 9 ); //999 // 왼쪽의 연산부터 수정하고 수행결과를 오른쪽과 연산함
        ...
        System.out.println("10과 20의 합 :" + (10 + 20)); // 괄호를 묶지않으면 물자열 합치기가 되어서 결과가 1020이 된다
        System.out.println("10과 20의 차 :" + (10 - 20)); // 문자열과은 마이너스 연산이 불가능하기에 물자열과 마이너스는 연산이 불가능하다. (반드시 괄호 사용)
