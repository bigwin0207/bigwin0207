...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        int age1 = 10; // 숫자가 처음에 시작하지 않으면 섞어서 가능하다.

        /* 목차 1-5. 특수기호는 '_'와 '$'만 사용 가능하다. */
        // int a@ge = 20; // 사용 가능한 특수문자 외에는 사용 불가능
        int _age = 20; //언더스코어(_)는 사용가능함. 처음도 가능하고 중간이나 끝에도 가능하다.
        int a$ge = 20; //달러($) 사용 가능함. 처음도 가능하고 중간이나 끝에도 가능하다.

        /* 2. 컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙 */
        /* 목차 2-1. 변수명의 길이제한은 없다. 하지만 적당히 하자. */
        int dfsakfjsaldfjaiesfjsilfaskdsakfnsdkafsa;
        ...
        /* 목차 2-6. 전형적인 변수 이름이 있따면 가급적 사용하도록 한다. */
        int sum = 0;        //더하기
        int max = 10;       //최댓값
        int min = 0;        //최솟값
        int count = 1;      //갯수
