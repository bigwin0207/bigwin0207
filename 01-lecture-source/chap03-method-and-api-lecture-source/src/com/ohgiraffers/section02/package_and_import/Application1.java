...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 클래스 명은 원래 패키지명을 포함 되어있기 때문이다. 예)com.ohgiraffers.section1.method.Calculator;(이게 클래스명이다.)
        *지금까지 클래스명에 패키지명을 함께 사용하지 않은 이유는 동일한 패키지 내에서 사용했기 때문이다.
        * 그렇기 때문에 서로 다른 패키지에 클래스를 사용하는 경우에는 클래스 명 앞에 패키명을 명시해서 풀 클래스 이름으로 사용해야한다.
        * */
