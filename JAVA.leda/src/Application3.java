...
public class Application3 {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("메소드 호출 시작함");

            int plus = Calculator.sumTwoNumber0f(first,second);
            int kin1 = Calculator.minusTwoNumber(first,num3);
            int kin2 = Calculator.multiTwoNumber(first,num3);
            int kin3 = Calculator.divideTwoNumber(first,num3);

            System.out.println("더하기 값 호출 : " + plus);
            System.out.println("빼기 값 호출 : " + kin1);
            System.out.println("곱하기 값 호출 : " + kin2);
            System.out.println("나누기 값 호출 : " + kin3 );
